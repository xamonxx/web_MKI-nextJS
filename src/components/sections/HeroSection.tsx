...
/**
 * HeroSection — pure Server Component, no animations on initial render.
 * LCP fix: content is immediately visible at opacity:1 from the first paint.
 * animate-float removed from mini-stat cards to eliminate continuous compositor work.
 */
    ...
    <section className="relative overflow-hidden bg-white pt-16 md:pt-16">
      ...
      <div className="container relative grid items-center gap-10 pb-12 pt-6 md:pb-16 md:pt-8 lg:grid-cols-[1.05fr_0.95fr] lg:gap-12 xl:min-h-[calc(100vh-5rem)] xl:pb-20 xl:pt-10">
        ...
        <div>
          ...
          {/* Mini-stats: animate-float removed — was causing continuous GPU compositor work */}
